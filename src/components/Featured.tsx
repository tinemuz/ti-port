...
import { Image } from "astro:assets"; // Replace with your actual Image component
                    ...
                    <div className="h-5  border-b border-mgray">
                      {index === currentIndex ? (
                        <div className="mx-1 flex h-full items-center justify-between text-[6px] md:text-xs">
                          <p>
                            {truncateTitle(writing.data.title).toUpperCase()}
                          </p>
                          <p>
                        ...
                        {index === currentIndex ? (
                          <a href={"/writing/" + writing.slug}>
                            <img
                              ...
                              width={writing.data.images[0].path.width}
                              height={writing.data.images[0].path.height}
                            />
                          </a>
                        ) : null}
                      </div>
