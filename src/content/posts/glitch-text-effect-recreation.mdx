---
title: "Text effect exploration"
description: "Recreating a cool text glitch effect"
...
<div className="hover-trigger bg-skin-bg-sub hover:text-skin-accent-sub mt-8 flex justify-between rounded-full px-10 py-10 font-mono text-2xl sm:px-20 sm:py-20 sm:text-[2.986rem]">
...
- <a href="https://jonasemmertsen.com/" target="_blank">
    Jonas' portfolio
  </a>
  - the inspiration for this
- <a href="https://codepen.io/vladsolomon/pen/RwzyBMZ" target="_blank">
    Vlad's code pen
  </a>
  - helped with creating a similar effect
